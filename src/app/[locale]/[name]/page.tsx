...
export default async function MovieDetail({params}: IMovieDetailProps) {
    ...
    return (
        <>
            ...
            <section className='w-full min-h-135 pb-10 backdrop-blur-lg before:content-[""] before:absolute before:inset-[3%] before:z-[-1] bg-radial to-58% from-transparent to-light dark:to-dark'>
                <div className='flex items-center justify-center flex-col lg:flex-row'>
                    <div className={`overflow-hidden pt-12 lg:rtl:pr-25 lg:rtl:pl-0 lg:pl-25 lg:pr-0`}>
                        <div className='relative'>
                            <img
                                className='rounded-xl w-81 object-contain pointer-events-none'
                                src={movie.cover}
                            /> 
                    ...
                    <div className='flex flex-col px-8 justify-start items-start flex-1 pt-4 lg:pt-0'>
            ...
            <main className='bg-light dark:bg-dark transition-item-none transition-color transition-padding '>
                <div className='relative lg:px-25 md:px-10 sm:px-10 px-5 py-4 pb-8'>
                    ...
                    <div className='border-[0.001rem] md:flex-row border-dark-second flex gap-4.5 flex-col dark:border-light-second p-8 rounded-md'>
                        ...
                        <div className='flex flex-1/2 flex-col gap-2 justify-start'>
                        <strong className={`pointer-events-none mb-1 text-dark text-lg tracking-wider transition-padding dark:text-light rtl:font-vazir font-roboto`}
                            >{t('movie.more-info')}</strong>
                            <div className='flex items-center gap-1.5'>
                            ...
                            <p
                                className={`text-theme-black dark:text-theme-white rtl:font-vazir font-roboto`}>{t('movie.summary')}:&nbsp;{movie.description}</p>
                        </div>
                    </div>
