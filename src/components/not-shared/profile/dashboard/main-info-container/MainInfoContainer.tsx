...
export default async function MainInfoContainer() {
    ...
    return (
        <div className='flex flex-col sm:mt-0 lg:flex-row w-full justify-between items-center gap-6 p-8 bg-light-second dark:bg-dark-between h-fit rounded-lg'>
            <div className='flex items-center gap-4 flex-col lg:flex-row'>
                ...
                <div className='md:flex-1 flex flex-col gap-2'>
                    ...
                    <p className='text-theme-black dark:text-theme-white font-roboto rtl:font-vazir text-justify'>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
